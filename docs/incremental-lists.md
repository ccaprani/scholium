...
- [Narration Format](narration-format.md) - Notes block syntax
- [Markdown Format](markdown-format.md) - Overall slide structure
- [Timing Control](timing-control.md) - Detailed timing directives
- [Examples](../examples.md) - Complete lecture examples
