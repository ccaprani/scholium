...
No additional setup. First generation downloads models (~1.5GB).

Next Steps
----------

* :doc:`quickstart` - Create your first video
* :doc:`/api/index` - Command reference
* :doc:`tts-providers` - Provider comparison
